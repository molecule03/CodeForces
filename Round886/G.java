...
//    Upsolved
    ...
    public static void main(String[] args) {
        ...
        for (int tt=0; tt<T; tt++) {
            ...
            int n = fs.nextInt();
            Map<Long, Long> north = new HashMap<>();
            Map<Long, Long> south = new HashMap<>();
            Map<Long, Long> east = new HashMap<>();
            ...
            for(int i=0; i<n; i++){
                ...
                west.put(x-y, west.getOrDefault(x-y, 0l)+1);
            }
...
//            out.println(west);
            ...
            long count = 0;
            for(long i : north.values()) count += i*(i-1);
            for(long i : south.values()) count += i*(i-1);
            for(long i : east.values()) count += i*(i-1);
            for(long i : west.values()) count += i*(i-1);
